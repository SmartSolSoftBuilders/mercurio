    ...
    <body>
        ...
        <spring:nestedPath path="datosPoliza">
            <form action="#" method="POST">
                ...
                <h2 align="center">Para autofinanciar la p&oacute;liza oprima el boton "Autofinanciar P&oacute;liza"</h2>
                <table width="450" border="0" align="center">
                    
                    <spring:bind path="polizaIndividual.numPoliza">                        
                        <input type="hidden" name="${status.expression}"  id="numPolizaFrm" value="<%= request.getParameter("poliza")%>" class="input"/>    
                    </spring:bind>
                    ...
                    <tr align="center">
                        <td width="150" >
                            <div align="center">                                
                                <input type="submit" class="input" value="Autofinanciar Poliza" name="_finish"/>
                            </div>
