...
<html>
    <head>
        ...
        <title>Cancelaci&oacute;n de p&oacute;liza exitoso</title>
    </head>
    <body>
        <jsp:include page="/jsp/menu.jsp"></jsp:include>
    				<br/><br/>
        <h2 align="center" class="Estilo1">La p&oacute;liza se ha autofinanciado correctamente</h2>
                ...
                <td width="150" >
                    <div align="center">
                        <a href="<c:url value="/"/>app/consultaPolizaController">
                            <input type="button" class="input" value="Consultar una poliza" />
                        </a>
                    </div>
                </td>
                <td width="150" >
