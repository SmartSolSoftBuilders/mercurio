...
<html>
    <head>
      ...
      function consultaPolizaAdminController(){
         document.location.href='<c:url value="/"/>app/consultaPolizaAdminController'
      }
      function generarFormatoAplicDescController(){
        document.location.href='<c:url value="/"/>app/generarFormatoAplicDescController'
      }
    ...
    <body>
        ...
        <table width="605" border="0" align="center" bgcolor="#DDDDDD">
            <td width="599">
                <table width="590" border="0" align="center" bordercolor="#DDDDDD" bgcolor="#aaaaaa">
              <tr align="center">
                <td width="141" >
                    <div align="center">
                ...
                <td width="258" >
                    <input name="button3" type="button"
                               onclick="javascript:generarFormatoAplicDescController()" 
                               value="Generar reporte de descuentos aplicados"/>
                </td>
              </tr>
              <tr>
