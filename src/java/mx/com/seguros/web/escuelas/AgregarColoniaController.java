...
/**
 * Controller para la atención de solicitudes de agregar un nuevo valor al catálogo de colonias
 * @author Emigdio Hernnadez
 *
 */
public class AgregarColoniaController extends SimpleFormController{
    ...
    public ModelAndView onSubmit(HttpServletRequest request,HttpServletResponse response, Object command,BindException errors) throws Exception{
		...
		colonia.setTipoAsentamiento(comando.getTipoAsentamiento());
		colonia.setAsentamiento(comando.getAsentamiento());
		colonia.setMunicipio(comando.getMunicipio());
		colonia.setEstado(comando.getEstado());
		administracionEmpresasService.agregarColonia(colonia);
		comando.setCveColonia(colonia.getCveColonia());
